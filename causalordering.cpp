 ...
 * Student ID: FJ37459
 * Assignment-2 Version with causalordering 
 */
...
//The below function is for sending the messages to all the processes
void *sender(void *r)
{
...
//The below function is for receiving the messages from all the processes
